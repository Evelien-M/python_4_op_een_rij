...
cur.execute("CREATE TABLE IF NOT EXISTS score (id INTEGER, player VARCHAR(45) NOT NULL, time INT NOT NULL, date datetime NOT NULL, difficulty varchar(45) NOT NULL, completed tinyint(4) NOT NULL, won tinyint(4) NOT NULL, PRIMARY KEY(id))")
...
cur.execute("INSERT INTO score VALUES (4, 'GUUS MEEUWIS', 16, '2021-10-11 00:00:00', 'hard', 1,0)")
